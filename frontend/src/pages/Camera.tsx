          ...
          const sub = (
            ...
            next: ({ data }: any) => {
              ...
              if (resPayload.status === "ERROR") {
                console.error("SEARCH ERROR", resPayload.message);
              } else {
    ...
    <div className="fixed inset-0 z-[60] bg-[#141414] flex flex-col overflow-hidden">
          ...
          {isAnalyzing && (
            ...
            >
              ...
              <h3 className="text-2xl font-light tracking-tight mb-2">
                Architectural <span className="font-bold">Analysis</span>
              </h3>
      ...
      <footer className="absolute bottom-0 left-0 right-0 z-20 pb-12 pt-8 px-10 bg-gradient-to-t from-black/60 via-black/30 to-transparent">
        <div className="max-w-4xl mx-auto flex items-center justify-between">
          ...
          >
            <div className="h-14 w-14 rounded-xl border-2 border-white/30 overflow-hidden bg-white p-0.5 transition-transform active:scale-95 flex items-center justify-center">
              <ImageIcon className="w-6 h-6 text-gray-400" />
            </div>
            <span className="text-[11px] font-bold text-white uppercase tracking-widest opacity-80">
              Gallery
            </span>
          </label>
            ...
            >
              <div className="h-full w-full rounded-full border-2 border-[#e7b923] bg-transparent flex items-center justify-center">
                <div className="h-14 w-14 rounded-full bg-white border border-gray-200 flex items-center justify-center">
                  {isAnalyzing && (
                    <Loader2 className="w-6 h-6 text-[#e7b923] animate-spin" />
                  )}
                </div>
              </div>
            </button>
        ...
        <div className="mt-8 flex justify-center gap-8">
          <button className="text-white text-xs font-bold uppercase tracking-[0.2em] border-b-2 border-[#e7b923] pb-1">
            Furniture
          </button>
          <button className="text-white/40 text-xs font-bold uppercase tracking-[0.2em] pb-1 hover:text-white transition-colors">
            Decor
          </button>
          <button className="text-white/40 text-xs font-bold uppercase tracking-[0.2em] pb-1 hover:text-white transition-colors">
            Lighting
